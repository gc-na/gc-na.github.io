---
layout: post
title: ASIC 반도체 설계 순서 flow ASIC半导体设计时序流程
subtitle: #ASIC #반도체 #설계 #SEMICONDUCTOR #FLOW #半导体
tags: [ASIC, 반도체, 설계, SEMICONDUCTOR, FLOW, 半导体]
comments: true
---
...
- 회로에 가장 큰 영향을 끼치는 구간.. Verilog HDL이나 VHDL이라는 하드웨어 언어 사용. 
