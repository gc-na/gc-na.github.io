---
layout: post
title: Design Compiler流程，DC流核心概念总结
subtitle: Design Compiler Flow
tags: [Design compiler, DC]
comments: true
---

1. DC에 필요한 setupfile을 만든다.
.synopsys_dc.setup
2. Vendor에서 Library 파일 받음
...
$ link
3. HDL file(Verilog HDL, VHDL 등) 불러오기.
...
SoC 회사에서 "DC 사용해보셨어요?" 질문은 Synopsys社의 tool로 synthesis 할 줄 아세요?라는 질문이래요!
