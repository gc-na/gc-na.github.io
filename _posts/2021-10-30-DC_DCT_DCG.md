---
layout: post
title: DC, DCT, DCG 차이. Synopsys Design Compiler Topographical Graphical Mode Wire Load Model
subtitle: What is the difference between DC, DCT and DCG?
tags: [Design Compiler]
comments: true
---

1. DC(dc_shell) - WLM 사용하는 Synthesis (미세공정에선 사용 힘듬.)
2. DCT(dc_shell -topographical) - DEF 갖고 Wire 값을 좀 더 실제적으로 Synthesis
3. DCG(compile_ultra -spg) - DCT의 개선 버전. Virtual Layout을 통해 Wire들이 한쪽에 과열되는 Hotspot을 막으면서 Synthesis
...
2. Topographical Mode : Default mode로 Synthesis 후, ddc로 저장하고, ICC에서 Floorplaning을 통해 DEF파일을 갖고, 배선 정보를 갖고 topographical Synthesis를 하는 것입니다.

![dct_flow](/assets/img/dct_flow.png)
...
![dcg_flow](/assets/img/DCG.png)  

DCG 장점.  

![dcg_flow](/assets/img/whyDCG.png)  

포스팅 하다보니, FinFET 공정과 디자인에 대해 알아보고 싶어어졌음... 저녁 먹고 와서 쓰는걸로.
