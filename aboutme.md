...
그래서 이 블로그에서 반도체 중심으로 글을 쓰고 있고, 덩달아 문화+투자+건강도 같이 쓰고 있습니다.

**VLSI란?**
저의 주력 연구 분야는, "VLSI를 더 효율적으로 설계 할 수 있는 방법론" (방법론 = 성능+전력+면적+개발비용 효율성)입니다.
VLSI Korea의 VLSI는 Very Large Scale Integraed Circuit입니다. 아래처럼 사진 같은 Chip을 VLSI라고 하는데요. (다른 칩보다 유별나게 큰 칩. 여기서 연산도 하고 저장도 하고 이것저것 한다. 메인이 되는 시스템.)

![title](/assets/img/aboutme1.png){: width="90%" height="90%"}{: .center}
​
...
- 현대미술 좋아해서 국립현대미술관에서 일했었고,
- 비행기 좋아해서 하늘에 모르는 비행기 있으면 어떤 비행기인가 찾아보기도 하고,
- 출판, 블로그, 외국어 공부, 클래식, 게임, 카페, 운동 .. 부캐가 많습니다.
- MBTI: ESTJ입니다. 극 ESTJ라서 가끔 소시오패스/사이코패스처럼 보일 수도 있는데, "로봇🤖같다"고 얘기해주시면, 눈치껏 언행 고치겠습니다.^^ 친구, 여자친구, 가족도 저한테 이렇게 말해요.
- 최애음식: 가리는거 없고 한식 좋아합니다, 카페는 거의 스타벅스만 갑니다. 스타벅스 주주에요. "바크콜에 에스프레소 휘핑 많이, 시럽 빼고" 추천드립니다. 저는 출신지가 김포인데요. 김포 갈 때만 스벅 안갑니다. 김포에 세계에서 제일 큰 카페도 있고, 예쁜카페가 많으니 궁금하시면 댓글 달아주세요.

**그리고, 질문 받습니다.**
반도체와 관련된 내용이라면 무엇이든 댓글로 질문을 주세요. 아는건 알려드리고, 모르는건 공부해서+배워와서 알려드릴게요.
*아래 내용과 관련된 경우 답변을 드리지 않습니다.

회사 기밀, 툴 라이센스, 여러분의 학교 과제, 제 프라이버시 (어디 회사 다니세요… 어디 사세요… 어디 학교 졸업하셨어요… MBTI 뭔가요… 여자친구 예쁜가요… 어제 왕십리에서 혼자 떡볶이 드셨나요… 궁금해하지마~!)
저는 우리 회사가 가장 잘 되었으면 하는 사람이에요.
그렇기 때문에 저는 official+standard하게 알려진 정보를 쉽게 풀어드릴 수는 있어도, 비법을 알려드릴 수는 없습니다.
궁금하면 제가 있는 회사를 찾아 우리 팀으로 오세요 ㅎㅎ
